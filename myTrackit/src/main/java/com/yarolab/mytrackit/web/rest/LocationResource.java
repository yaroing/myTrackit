...
import com.yarolab.mytrackit.repository.LocationRepository;
...
/**
 * REST controller for managing {@link com.yarolab.mytrackit.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class LocationResource {
    ...
    public Mono<ResponseEntity<Location>> partialUpdateLocation(
        ...
        return locationRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Location> result = locationRepository
    ...
    public Mono<List<Location>> getAllLocations() {
        ...
        return locationRepository.findAll().collectList();
    }
