...
/**
 * REST controller for managing {@link com.yarolab.mytrackit.domain.RequetePointService}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RequetePointServiceResource {
    ...
    private static final String ENTITY_NAME = "requetePointService";
    ...
    public Mono<ResponseEntity<RequetePointService>> createRequetePointService(@RequestBody RequetePointService requetePointService)
        ...
        return requetePointServiceRepository
            .save(requetePointService)
            .map(result -> {
                try {
    ...
    public Mono<ResponseEntity<RequetePointService>> updateRequetePointService(
    ...
    public Mono<ResponseEntity<RequetePointService>> partialUpdateRequetePointService(
        @PathVariable(value = "id", required = false) final Long id,
        @RequestBody RequetePointService requetePointService
    ) throws URISyntaxException {
        ...
        return requetePointServiceRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<RequetePointService> result = requetePointServiceRepository
                    ...
                    .flatMap(requetePointServiceRepository::save);
    ...
    public Mono<List<RequetePointService>> getAllRequetePointServices() {
        log.debug("REST request to get all RequetePointServices");
        return requetePointServiceRepository.findAll().collectList();
    }

    /**
     * {@code GET  /requete-point-services} : get all the requetePointServices as a stream.
     * @return the {@link Flux} of requetePointServices.
     */
    @GetMapping(value = "/requete-point-services", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<RequetePointService> getAllRequetePointServicesAsStream() {
        log.debug("REST request to get all RequetePointServices as a stream");
    ...
    public Mono<ResponseEntity<RequetePointService>> getRequetePointService(@PathVariable Long id) {
        log.debug("REST request to get RequetePointService : {}", id);
        Mono<RequetePointService> requetePointService = requetePointServiceRepository.findById(id);
    ...
    public Mono<ResponseEntity<Void>> deleteRequetePointService(@PathVariable Long id) {
