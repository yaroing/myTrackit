...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './staff.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STAFF_LIST actions', async () => {
    ...
    it('dispatches FETCH_STAFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STAFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STAFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STAFF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STAFF actions', async () => {
      const expectedActions = [
        {
