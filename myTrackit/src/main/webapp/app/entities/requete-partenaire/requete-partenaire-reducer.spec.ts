...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './requete-partenaire.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUETEPARTENAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUETEPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUETEPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUETEPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUETEPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUETEPARTENAIRE actions', async () => {
      const expectedActions = [
        {
