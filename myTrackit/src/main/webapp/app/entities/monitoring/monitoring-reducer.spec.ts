...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONITORING_LIST actions', async () => {
    ...
    it('dispatches FETCH_MONITORING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MONITORING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MONITORING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MONITORING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MONITORING actions', async () => {
      const expectedActions = [
        {
