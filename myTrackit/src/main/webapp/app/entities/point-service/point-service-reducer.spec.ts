...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POINTSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POINTSERVICE actions', async () => {
      const expectedActions = [
        {
