...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zrosts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZROSTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ZROSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ZROSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ZROSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ZROSTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ZROSTS actions', async () => {
      const expectedActions = [
        {
