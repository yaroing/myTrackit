...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './stock-point-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKPOINTSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
