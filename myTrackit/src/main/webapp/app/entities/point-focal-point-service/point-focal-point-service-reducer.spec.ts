...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './point-focal-point-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POINTFOCALPOINTSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POINTFOCALPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POINTFOCALPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POINTFOCALPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POINTFOCALPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POINTFOCALPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
