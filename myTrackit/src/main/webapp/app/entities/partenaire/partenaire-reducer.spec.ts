...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTENAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTENAIRE actions', async () => {
      const expectedActions = [
        {
