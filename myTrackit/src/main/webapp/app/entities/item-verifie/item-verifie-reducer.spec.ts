...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMVERIFIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMVERIFIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMVERIFIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMVERIFIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMVERIFIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMVERIFIE actions', async () => {
      const expectedActions = [
        {
