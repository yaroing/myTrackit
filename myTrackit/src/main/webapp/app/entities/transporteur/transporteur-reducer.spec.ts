...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSPORTEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSPORTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSPORTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSPORTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSPORTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSPORTEUR actions', async () => {
      const expectedActions = [
        {
