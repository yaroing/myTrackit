...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './section.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SECTION actions', async () => {
      const expectedActions = [
        {
