...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './requete-point-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUETEPOINTSERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUETEPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUETEPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUETEPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUETEPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUETEPOINTSERVICE actions', async () => {
      const expectedActions = [
        {
