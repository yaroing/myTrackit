...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUIVIMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUIVIMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUIVIMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUIVIMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUIVIMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUIVIMISSION actions', async () => {
      const expectedActions = [
        {
