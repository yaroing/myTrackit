...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './transfert.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFERT actions', async () => {
      const expectedActions = [
        {
