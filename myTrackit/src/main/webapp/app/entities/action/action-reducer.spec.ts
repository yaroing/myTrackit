...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './action.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTION actions', async () => {
      const expectedActions = [
        {
