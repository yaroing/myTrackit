...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETAILSREQUETE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETAILSREQUETE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETAILSREQUETE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETAILSREQUETE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETAILSREQUETE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETAILSREQUETE actions', async () => {
      const expectedActions = [
        {
