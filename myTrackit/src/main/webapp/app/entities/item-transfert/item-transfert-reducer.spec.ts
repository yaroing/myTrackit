...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMTRANSFERT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMTRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMTRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMTRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMTRANSFERT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMTRANSFERT actions', async () => {
      const expectedActions = [
        {
