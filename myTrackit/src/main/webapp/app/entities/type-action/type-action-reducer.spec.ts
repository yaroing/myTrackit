...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEACTION actions', async () => {
      const expectedActions = [
        {
