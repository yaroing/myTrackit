...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './point-focal-partenaire.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POINTFOCALPARTENAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POINTFOCALPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POINTFOCALPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POINTFOCALPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POINTFOCALPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POINTFOCALPARTENAIRE actions', async () => {
      const expectedActions = [
        {
