...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKPARTENAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STOCKPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKPARTENAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKPARTENAIRE actions', async () => {
      const expectedActions = [
        {
