...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yarolab.mytrackit.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yarolab.mytrackit.security.DomainUserDetailsService", "createSpringSecurityUser");
