...
class SuiviMissionResourceIT {
    ...
    private static final Integer DEFAULT_MISSION_EUM_ID = 1;
    private static final Integer UPDATED_MISSION_EUM_ID = 2;
    ...
    private static final Integer DEFAULT_STATUT_RECOM_ID = 1;
    private static final Integer UPDATED_STATUT_RECOM_ID = 2;
    ...
    public static SuiviMission createEntity(EntityManager em) {
        SuiviMission suiviMission = new SuiviMission()
            .missionEumId(DEFAULT_MISSION_EUM_ID)
            ...
            .statutRecomId(DEFAULT_STATUT_RECOM_ID);
        return suiviMission;
    }
    ...
    public static SuiviMission createUpdatedEntity(EntityManager em) {
        SuiviMission suiviMission = new SuiviMission()
            .missionEumId(UPDATED_MISSION_EUM_ID)
            ...
            .statutRecomId(UPDATED_STATUT_RECOM_ID);
        return suiviMission;
    }
    ...
    void createSuiviMission() throws Exception {
        ...
        assertThat(testSuiviMission.getMissionEumId()).isEqualTo(DEFAULT_MISSION_EUM_ID);
        ...
        assertThat(testSuiviMission.getStaffId()).isEqualTo(DEFAULT_STAFF_ID);
        assertThat(testSuiviMission.getDateEcheance()).isEqualTo(DEFAULT_DATE_ECHEANCE);
        assertThat(testSuiviMission.getStatutRecomId()).isEqualTo(DEFAULT_STATUT_RECOM_ID);
    }
    ...
    void getAllSuiviMissions() throws Exception {
        ...
        restSuiviMissionMockMvc
            ...
            .andExpect(jsonPath("$.[*].missionEumId").value(hasItem(DEFAULT_MISSION_EUM_ID)))
            ...
            .andExpect(jsonPath("$.[*].statutRecomId").value(hasItem(DEFAULT_STATUT_RECOM_ID)));
    }
    ...
    void getSuiviMission() throws Exception {
        ...
        restSuiviMissionMockMvc
            ...
            .andExpect(jsonPath("$.missionEumId").value(DEFAULT_MISSION_EUM_ID))
            ...
            .andExpect(jsonPath("$.statutRecomId").value(DEFAULT_STATUT_RECOM_ID));
    }
    ...
    void putExistingSuiviMission() throws Exception {
        ...
        SuiviMission testSuiviMission = suiviMissionList.get(suiviMissionList.size() - 1);
        assertThat(testSuiviMission.getMissionEumId()).isEqualTo(UPDATED_MISSION_EUM_ID);
        ...
        assertThat(testSuiviMission.getStaffId()).isEqualTo(UPDATED_STAFF_ID);
        assertThat(testSuiviMission.getDateEcheance()).isEqualTo(UPDATED_DATE_ECHEANCE);
        assertThat(testSuiviMission.getStatutRecomId()).isEqualTo(UPDATED_STATUT_RECOM_ID);
    }
