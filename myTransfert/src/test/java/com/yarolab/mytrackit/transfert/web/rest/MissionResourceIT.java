...
class MissionResourceIT {
    ...
    void createMission() throws Exception {
        ...
        assertThat(testMission.getSectionId()).isEqualTo(DEFAULT_SECTION_ID);
        assertThat(testMission.getStaffId()).isEqualTo(DEFAULT_STAFF_ID);
        assertThat(testMission.getRegionId()).isEqualTo(DEFAULT_REGION_ID);
        assertThat(testMission.getPartenaireId()).isEqualTo(DEFAULT_PARTENAIRE_ID);
    ...
    void putExistingMission() throws Exception {
        ...
        assertThat(testMission.getSectionId()).isEqualTo(UPDATED_SECTION_ID);
        assertThat(testMission.getStaffId()).isEqualTo(UPDATED_STAFF_ID);
        assertThat(testMission.getRegionId()).isEqualTo(UPDATED_REGION_ID);
        assertThat(testMission.getPartenaireId()).isEqualTo(UPDATED_PARTENAIRE_ID);
