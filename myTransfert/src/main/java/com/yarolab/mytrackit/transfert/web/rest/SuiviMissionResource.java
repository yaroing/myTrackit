    ...
    public ResponseEntity<SuiviMission> partialUpdateSuiviMission(
        ...
        Optional<SuiviMission> result = suiviMissionRepository
            ...
            .map(existingSuiviMission -> {
                if (suiviMission.getMissionEumId() != null) {
                    existingSuiviMission.setMissionEumId(suiviMission.getMissionEumId());
                }
                ...
                if (suiviMission.getStaffId() != null) {
                    existingSuiviMission.setStaffId(suiviMission.getStaffId());
                }
                if (suiviMission.getDateEcheance() != null) {
                    existingSuiviMission.setDateEcheance(suiviMission.getDateEcheance());
                }
                if (suiviMission.getStatutRecomId() != null) {
                    existingSuiviMission.setStatutRecomId(suiviMission.getStatutRecomId());
                }
