...
/**
 * REST controller for managing {@link com.yarolab.mytrackit.transfert.domain.Action}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ActionResource {
    ...
    private static final String ENTITY_NAME = "myTransfertAction";
    ...
    public ResponseEntity<Action> partialUpdateAction(
        ...
        Optional<Action> result = actionRepository
            ...
            .map(existingAction -> {
                if (action.getTransfertId() != null) {
                    existingAction.setTransfertId(action.getTransfertId());
                }
                if (action.getDateAction() != null) {
                    existingAction.setDateAction(action.getDateAction());
                }
                if (action.getTypeActionId() != null) {
                    existingAction.setTypeActionId(action.getTypeActionId());
                }
                if (action.getRapportAction() != null) {
                    existingAction.setRapportAction(action.getRapportAction());
                }
                if (action.getStaffId() != null) {
                    existingAction.setStaffId(action.getStaffId());
                }
