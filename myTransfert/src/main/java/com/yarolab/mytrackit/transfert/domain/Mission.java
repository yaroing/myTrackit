...
public class Mission implements Serializable {
    ...
    public Mission sectionId(Integer sectionId) {
    ...
    public Mission staffId(Integer staffId) {
    ...
    public Mission regionId(Integer regionId) {
    ...
    public Mission partenaireId(String partenaireId) {
