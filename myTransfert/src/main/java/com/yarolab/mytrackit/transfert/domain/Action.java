...
public class Action implements Serializable {
    ...
    public Action transfertId(Integer transfertId) {
        this.setTransfertId(transfertId);
        return this;
    }
    ...
    public Action typeActionId(Integer typeActionId) {
    ...
    public Action staffId(Integer staffId) {
