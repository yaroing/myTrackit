...
import com.yarolab.mytrackit.coreservice.repository.SectionRepository;
...
/**
 * REST controller for managing {@link com.yarolab.mytrackit.coreservice.domain.Section}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class SectionResource {
    ...
    private static final String ENTITY_NAME = "myCoreServiceSection";
