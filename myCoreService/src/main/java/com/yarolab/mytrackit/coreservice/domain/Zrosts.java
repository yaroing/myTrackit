...
public class Zrosts implements Serializable {
    ...
    @Column(name = "zrosts_id")
    private Double zrostsId;
    ...
    public Double getZrostsId() {
        return this.zrostsId;
    }

    public Zrosts zrostsId(Double zrostsId) {
        this.setZrostsId(zrostsId);
        return this;
    }

    public void setZrostsId(Double zrostsId) {
        this.zrostsId = zrostsId;
    }
