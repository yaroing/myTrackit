...
class CatalogueResourceIT {
    ...
    public static Catalogue createEntity(EntityManager em) {
        Catalogue catalogue = new Catalogue().materialDesc(DEFAULT_MATERIAL_DESC).materialGroup(DEFAULT_MATERIAL_GROUP);
        return catalogue;
    }
    ...
    public static Catalogue createUpdatedEntity(EntityManager em) {
        Catalogue catalogue = new Catalogue().materialDesc(UPDATED_MATERIAL_DESC).materialGroup(UPDATED_MATERIAL_GROUP);
        return catalogue;
    }
    ...
    void putExistingCatalogue() throws Exception {
        ...
        updatedCatalogue.materialDesc(UPDATED_MATERIAL_DESC).materialGroup(UPDATED_MATERIAL_GROUP);
    ...
    void partialUpdateCatalogueWithPatch() throws Exception {
        ...
        partialUpdatedCatalogue.materialDesc(UPDATED_MATERIAL_DESC);
    ...
    void fullUpdateCatalogueWithPatch() throws Exception {
        ...
        partialUpdatedCatalogue.materialDesc(UPDATED_MATERIAL_DESC).materialGroup(UPDATED_MATERIAL_GROUP);
