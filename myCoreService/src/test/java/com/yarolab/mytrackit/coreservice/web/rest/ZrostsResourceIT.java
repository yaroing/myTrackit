...
class ZrostsResourceIT {
    ...
    private static final Double DEFAULT_ZROSTS_ID = 1D;
    private static final Double UPDATED_ZROSTS_ID = 2D;
    ...
    void createZrosts() throws Exception {
        ...
        assertThat(testZrosts.getZrostsId()).isEqualTo(DEFAULT_ZROSTS_ID);
    ...
    void getAllZrosts() throws Exception {
        ...
        restZrostsMockMvc
            ...
            .andExpect(jsonPath("$.[*].zrostsId").value(hasItem(DEFAULT_ZROSTS_ID.doubleValue())))
    ...
    void getZrosts() throws Exception {
        ...
        restZrostsMockMvc
            ...
            .andExpect(jsonPath("$.zrostsId").value(DEFAULT_ZROSTS_ID.doubleValue()))
    ...
    void putExistingZrosts() throws Exception {
        ...
        Zrosts testZrosts = zrostsList.get(zrostsList.size() - 1);
        assertThat(testZrosts.getZrostsId()).isEqualTo(UPDATED_ZROSTS_ID);
