...
class StockPointServiceResourceIT {
    ...
    void createStockPointService() throws Exception {
        ...
        assertThat(testStockPointService.getPosId()).isEqualTo(DEFAULT_POS_ID);
        ...
        assertThat(testStockPointService.getCatalogueId()).isEqualTo(DEFAULT_CATALOGUE_ID);
    ...
    void putExistingStockPointService() throws Exception {
        ...
        StockPointService testStockPointService = stockPointServiceList.get(stockPointServiceList.size() - 1);
        assertThat(testStockPointService.getPosId()).isEqualTo(UPDATED_POS_ID);
        ...
        assertThat(testStockPointService.getCatalogueId()).isEqualTo(UPDATED_CATALOGUE_ID);
