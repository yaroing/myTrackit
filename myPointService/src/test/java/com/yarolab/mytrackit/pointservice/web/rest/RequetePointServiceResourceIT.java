...
class RequetePointServiceResourceIT {
    ...
    void createRequetePointService() throws Exception {
        ...
        assertThat(testRequetePointService.getPosId()).isEqualTo(DEFAULT_POS_ID);
        assertThat(testRequetePointService.getCatalogueId()).isEqualTo(DEFAULT_CATALOGUE_ID);
    ...
    void getAllRequetePointServices() throws Exception {
        ...
        restRequetePointServiceMockMvc
            ...
            .andExpect(jsonPath("$.[*].posId").value(hasItem(DEFAULT_POS_ID)))
    ...
    void getRequetePointService() throws Exception {
        ...
        restRequetePointServiceMockMvc
            ...
            .andExpect(jsonPath("$.posId").value(DEFAULT_POS_ID))
    ...
    void putExistingRequetePointService() throws Exception {
        ...
        RequetePointService testRequetePointService = requetePointServiceList.get(requetePointServiceList.size() - 1);
        assertThat(testRequetePointService.getPosId()).isEqualTo(UPDATED_POS_ID);
        assertThat(testRequetePointService.getCatalogueId()).isEqualTo(UPDATED_CATALOGUE_ID);
