    ...
    public ResponseEntity<RequetePointService> partialUpdateRequetePointService(
        ...
        Optional<RequetePointService> result = requetePointServiceRepository
            ...
            .map(existingRequetePointService -> {
                if (requetePointService.getPosId() != null) {
                    existingRequetePointService.setPosId(requetePointService.getPosId());
                }
                if (requetePointService.getCatalogueId() != null) {
                    existingRequetePointService.setCatalogueId(requetePointService.getCatalogueId());
                }
